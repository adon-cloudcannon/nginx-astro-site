...
<Code_Block language="json" hints={[{ number: "1", display_text: "uri", tooltip: "Matches direct URLs and the administrative section of the site", nxt_type: "nxt_hint" }, { number: "2", display_text: "share", tooltip: "Serves matching static files", nxt_type: "nxt_hint" }, { number: "3", display_text: "/path/to/app", tooltip: "Path to the application directory; use a real path in your configuration", nxt_type: "nxt_ph" }, { number: "4", display_text: "applications/joomla/index", tooltip: "Unconditionally matches all remaining URLs, including rewritten ones", nxt_type: "nxt_hint" }, { number: "5", display_text: "/path/to/app/", tooltip: "Path to the application directory; use a real path in your configuration", nxt_type: "nxt_ph" }, { number: "6", display_text: "/path/to/app/", tooltip: "Path to the application directory; use a real path in your configuration", nxt_type: "nxt_ph" }, { number: "7", display_text: "index.php", tooltip: "All requests are handled by a single script", nxt_type: "nxt_hint" }]}>{`   {
       "listeners": {
           "*:80": {
               "pass": "routes"
           }
