...
<Tabs label="wasm-wasi-component/unit-wasm">
  ...
  <Tab name="unit-wasm">
    ...
    <Code_Block language="console" hints={[{ number: "1", display_text: "/path/to/wasi-sysroot-dir/", tooltip: "wasi-sysroot directory", nxt_type: "nxt_hint" }]}>{`WASI_SYSROOT=NXT1`}</Code_Block>
  </Tab>
</Tabs>
</Dropdown>
