...
After a successful update, Jira should be available on the listener’s IP address and port.  Browse to [http://localhost/jira](http://localhost/jira) to continue the setup in your browser: ![Jira on Unit - Setup Screen](/jira.png)