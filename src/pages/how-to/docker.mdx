...
To run your apps in a containerized Unit using the [images we provide](../installation.md#installation-docker), you need at least to:<NXT_Hint tooltip="Socket path inside the container" display_text="/var/run/control.unit.sock"/>
