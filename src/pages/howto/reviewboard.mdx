...
After a successful update, browse to [http://localhost](http://localhost) and [set up](https://www.reviewboard.org/docs/manual/dev/admin/#configuring-review-board) your Review Board installation: ![Review Board on Unit - Dashboard Screen](/reviewboard.png)