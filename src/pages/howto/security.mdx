...
`# ls -l /        :nxt_hint:drwxr-xr-x &lt;Permissions are OK&gt;  some_user some_group  path  # ls -l /path/        :nxt_hint:drwxr-x--- &lt;Permissions are too restrictive&gt;  some_user some_group  to `
