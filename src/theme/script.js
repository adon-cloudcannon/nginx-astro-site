    ...
    */
    ...
    for (let el of document.getElementsByClassName('highlight')) {        
        ...
        pre.innerHTML = html.slice(0, pos)
                        ...
                        + html.slice(pos)
        let btn_clone = btn.cloneNode(true)
        btn_clone.addEventListener("click",e => {
            nxt_copy(e.target)
        })
        el.appendChild(btn_clone)        
    }
