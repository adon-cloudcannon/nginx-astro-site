...
<table><tbody><tr><td><strong>--no-regex</strong></td><td>Turns off regex support; any attempts to use a regex in Unit<br />configuration cause an error.</td></tr><tr><td><strong>--no-pcre2</strong></td><td>Ignores PCRE2; the older PCRE 8.x library is used instead.</td></tr></tbody></table>
...
<table><tbody><tr><td><strong>--njs</strong></td><td>Turns on <strong>njs</strong> support; requires <strong>--openssl</strong>.</td></tr></tbody></table>
