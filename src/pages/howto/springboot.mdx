...
2\. Create your Spring Boot project; we’ll use the [quickstart](https://spring.io/quickstart) example, creating it at [https://start.spring.io](https://start.spring.io): ![Spring Initializr - Project Setup Screen](/images/springboot.png)
